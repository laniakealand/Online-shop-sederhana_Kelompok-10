...
#ROCK
    ...
    #POP
        ...
        if pilihan_3 == "1":
            ...
            print("Terimakasih telah mengunjungi genre lagu pop.")
        else:
             print("Maaf pilihan yang anda masukkan tidak tersedia.")
             pilihan_4 = input("Apakah anda ingin kembali ke menu awal? (Ya/Tidak) ")
             if pilihan_4.lower() == "ya":
...
#K-POP
        ...
        if pilihan_3 == "1":
            ...
            print("Terimakasih telah mengunjungi genre lagu kpop.")
        else:
             print("Maaf pilihan yang anda masukkan tidak tersedia.")
             pilihan_4 = input("Apakah anda ingin kembali ke menu awal? (Ya/Tidak) ")
             if pilihan_4.lower() == "ya":
